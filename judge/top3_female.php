            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Top 3 Candidates</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <h3>Top 3 Candidates</h3>
                            <form action="./function/top3_female_function.php" method="post">
                                <table class="table table-striped table-bordered" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT `cand_no`, `cand_fn`, `cand_ln`, `cand_team` FROM `top3_candidate_female` WHERE 1";
