        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4 mt-4">
                    ...
                    ?>
                    <h1 class="mt-4">Swim Wear Candidates (Female)</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Swim Wear Candidates (Female)</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <h3>Swim Wear Candidates (Female)</h3>
                            <form action="./function/swimwear_score_female.php" method="post">
