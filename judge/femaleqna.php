        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    ?>
                    <h1 class="mt-4">Q&A Candidates (Female)</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Q&A Candidates (Female)</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <h3>Q&A Candidates (Female)</h3>
                            <form action="./function/qna_score_female.php" method="post">
