...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO top3_candidate_female (cand_no, cand_fn, cand_ln, cand_team) VALUES (?, ?, ?, ?)");
    ...
    $stmt->close();
    $_SESSION['success_message'] = "Top 3 Male Candidates saved successfully!";
