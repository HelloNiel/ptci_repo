...
$query_male = "
    ...
    FROM top3_candidate_male c
    LEFT JOIN top3_scores_male us ON c.cand_no = us.cand_no
    GROUP BY c.cand_no
...
$sheet->setTitle('Top 3 Finalists');

$sheet->getPageSetup()->setOrientation(\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE);

$sheet->setCellValue('A1', 'Top 3 Finalists of Mr. and Ms. PTCI 2024');
...
$query_female = "
    ...
    IFNULL(MAX(CASE WHEN us.judge_id = 49 THEN us.score END), 0) +
    IFNULL(MAX(CASE WHEN us.judge_id = 50 THEN us.score END), 0)) / 5 AS total_score
    FROM top3_candidate_female c
    LEFT JOIN top3_scores_female us ON c.cand_no = us.cand_no
    GROUP BY c.cand_no
    ORDER BY total_score DESC
    LIMIT 3
";
...
$filename = 'Top_3_Finalists_Mr_and_Ms_PTCI_2024.xlsx';
