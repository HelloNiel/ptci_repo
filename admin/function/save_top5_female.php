...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $conn->query("DELETE FROM top5_candidate_female");

    $stmt = $conn->prepare("INSERT INTO top5_candidate_female (cand_no, cand_fn, cand_ln, cand_team) VALUES (?, ?, ?, ?)");
    ...
    $stmt->close();
    $_SESSION['success_message'] = "Top 5 Female Candidates saved successfully!";
