        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form action="./function/save_top_5_male.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary">Save Top 5 Male Candidates</button>
                    </form>
                    ...
                    ?>
                    <h2>Top 5 Female Candidates Total Scores</h2>
                    <form action="./function/save_top5_female.php" method="POST">
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>Rank</th>
